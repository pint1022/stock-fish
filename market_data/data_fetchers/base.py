...
from market_data.compat import record_provider_run
...
def _is_us_market(code: str) -> bool:
    ...
    from market_data.data_fetchers.us_index_mapping import is_us_stock_code, is_us_index_code
...
class DataFetcherManager:
    ...
    def __init__(self, fetchers: Optional[List[BaseFetcher]] = None):
        ...
        from market_data.data_fetchers.yfinance_fundamental_adapter import YfinanceFundamentalAdapter
    ...
    def _get_tickflow_fetcher(self):
        ...
        with self._tickflow_lock:
            ...
            try:
                from market_data.data_fetchers.tickflow_fetcher import TickFlowFetcher
    ...
    def _init_default_fetchers(self) -> None:
        ...
        """
        from market_data.compat import get_config
        from market_data.data_fetchers.efinance_fetcher import EfinanceFetcher
        from market_data.data_fetchers.akshare_fetcher import AkshareFetcher
        from market_data.data_fetchers.tushare_fetcher import TushareFetcher
        from market_data.data_fetchers.pytdx_fetcher import PytdxFetcher
        ...
        if finnhub_api_key:
            from market_data.data_fetchers.finnhub_fetcher import FinnhubFetcher
        ...
        if alphavantage_api_key:
            from market_data.data_fetchers.alphavantage_fetcher import AlphaVantageFetcher
    ...
    def get_chip_distribution(self, stock_code: str):
        ...
        from market_data.data_fetchers.realtime_types import get_chip_circuit_breaker
        from market_data.compat import get_config
